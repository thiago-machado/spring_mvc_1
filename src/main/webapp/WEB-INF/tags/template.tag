...
<%@ attribute name="extraScripts" fragment="true" %> <!-- utilizado quando se precisa de scripts javascript em páginas específicas -->
...
<body class="${ bodyClass }">
	...
	<jsp:doBody />
	<jsp:invoke fragment="extraScripts" /><!-- o import de scripts específicos deve ser feito após doBody. consultar home.jsp para verificar como fica página -->
